...
// フォロー削除機能
Route::get('/follow/{id}/delete', 'PostsController@unfollow')->middleware('auth');
// 管理者画面
...
// ログの管理
Route::get('logs', '\Rap2hpoutre\LaravelLogViewer\LogViewerController@index')->middleware('auth')->middleware('adminid');
